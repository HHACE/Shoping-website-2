                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="d-flex justify-content-end">
                                <button class="product-button float-end">
                                    <a href="/homeManagement/productManagement/addNewProduct" class="product-button-word">Add new product</a>
                                </button>
                                <p>${msg}</p>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listProduct}" var="pro">
                                            <tr>
                                                ...
                                                <td>${pro.discount}%</td>
                                                <td>${pro.status}</td>
                                                <td class="view-detail"><a href="/homeManagement/productDetailForManagement?productId=${pro.product_id}">View Detail</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
