                ...
                <div class="rounded d-flex justify-content-center" style="margin-bottom: 70px;">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 background-light" style="background-color: rgba(255, 255, 255, 0.4); border-radius: 25px;">
                        <div class="text-center">
                            <h3 style="margin-top:30px; color: #27A4F2; padding: 20px; padding-bottom: 20px; letter-spacing: 5px">ADD NEW BRAND</h3>
                        </div>
                        <form id="loginform" method="POST" action="manager">
                            <div style="padding: 20px 48px;">
                                <div class="row input-group mb-3">
                                    <input name="brandId" type="text" class="col-lg-10 col-md-10 col-sm-8 form-control" placeholder="Enter brand id">
                                </div>
                                <div class="row input-group mb-3">
                                    <input name="brandName" type="text" class="col-lg-10 col-md-10 col-sm-8 form-control" placeholder="Enter brand name">
                                </div>
                                ...
                                <div class="login-button" style="margin-top: 25px">
                                    <a href="/homeManagement/brandManagement" class="w-50 mx-auto btn btn-primary text-center mt-2" style="display: flex; justify-content: center; background: #27A4F2; border: none; padding: 10px; text-decoration: none;">
                                        Go back
                                    </a>
                                    <button class="w-50 mx-auto btn btn-primary text-center mt-2" style="display: flex; justify-content: center; background: #27A4F2; border: none; padding: 10px" type="submit" name="btnAddNewBrand">
                                        Add new brand
                                    </button>
                                </div>
                            </div>
