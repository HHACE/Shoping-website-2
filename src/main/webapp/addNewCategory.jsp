                ...
                <div class="rounded d-flex justify-content-center" style="margin-bottom: 70px;">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 background-light" style="background-color: rgba(255, 255, 255, 0.4); border-radius: 25px;">
                        <div class="text-center">
                            <h3 style="margin-top:30px; color: #27A4F2; padding: 20px; padding-bottom: 20px; letter-spacing: 5px">ADD NEW CATEGORY</h3>
                        </div>
                        <form id="loginform" method="POST" action="manager">
                            <div style="padding: 20px 48px;">
                                <div class="row input-group mb-3">
                                    <input name="categoryId" type="text" class="col-lg-10 col-md-10 col-sm-8 form-control" placeholder="Enter category id">
                                </div>
                                <div class="row input-group mb-3">
                                    <input name="categoryName" type="text" class="col-lg-10 col-md-10 col-sm-8 form-control" placeholder="Enter category name">
                                </div>
                                ...
                                <div class="login-button" style="margin-top: 25px">
                                    <a href="/homeManagement/categoryManagement" class="w-50 mx-auto btn btn-primary text-center mt-2" style="display: flex; justify-content: center; background: #27A4F2; border: none; padding: 10px; text-decoration: none;">
                                        Go back
                                    </a>
                                    <button class="w-50 mx-auto btn btn-primary text-center mt-2" style="display: flex; justify-content: center; background: #27A4F2; border: none; padding: 10px" type="submit" name="btnAddNewCategory">
                                        Add new category
                                    </button>
                                </div>
                            </div>
