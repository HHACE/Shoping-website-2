<%-- 
    ...
    Created on : Oct 24, 2023, 2:51:18 PM
    Author     : namti
--%>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">STAFF MANAGEMENT</h6>
                            <div class="d-flex justify-content-end">
                                <button class="product-button float-end">
                                    <a href="/homeManagement/staffManagement/addNewStaff" class="product-button-word">Add new staff</a>
                                </button>
                            </div>
                                            ...
                                            <c:choose>
                                                <c:when test="${staff.role_id != 1}">
                                                    <tr>
                                                        ...
                                                        <td class="view-detail"><a href="/homeManagement/staffManagement/deleteStaff/${staff.manager_id}"><i class="fas fa-user-slash"></i></a></td>
                                                    </tr>
                                                </c:when>
                                            </c:choose>
                                        </c:forEach>
