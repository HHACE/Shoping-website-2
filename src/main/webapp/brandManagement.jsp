                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">BRAND MANAGEMENT</h6>
                            <div class="d-flex justify-content-end">
                                <button class="product-button float-end">
                                    <a href="/homeManagement/brandManagement/addNewBrand" class="product-button-word">Add new brand</a>
                                </button>
                            </div>
